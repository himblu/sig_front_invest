...
export class ProjectListComponent extends OnDestroyMixin implements OnInit, OnDestroy {
  ...
  public pageSizeOptions: number[] = [5, 10, 25, 50, 100];
	...
	public getProjectPractices(): void{
		this.admin.getStudentsProjectPractices(this.pageIndex, this.pageSize, this.filtersForm.get('search').value, +sessionStorage.getItem('studentID'), this.filtersForm.get('state').value).subscribe({
			next: (res) => {
