...
import { EnrolledStudent } from '@utils/interfaces/person.interfaces';
...
export class ValidateDocumentComponent {
  ...
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: { enrolledStudent: EnrolledStudent }
  ) {
		//console.log(data);
